    ...
    <div className="services-grid">
      {services.map((s) =>
        s.tag === "CONTEÚDO" ? (
          ...
          >
            <span style={{ fontFamily: "var(--font-inter), sans-serif", display: "inline-block", alignSelf: "flex-start", fontSize: 11, fontWeight: 700, color: C.green, letterSpacing: "0.08em", backgroundColor: C.greenFaint, padding: "4px 10px", borderRadius: 4 }}>{s.tag}</span>
            <h3 style={{ fontFamily: "var(--font-inter), sans-serif", fontWeight: 700, fontSize: 17, color: C.text, lineHeight: 1.3 }}>{s.title}</h3>
